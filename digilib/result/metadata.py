...
from digilib.misc.time import latest_datetime, total_timedelta, date_to_string,\
    timedelta_to_string
...
import digilib
from digilib import translate
from digilib.memory import Memory
...
class Metadata(Result_object):
    ...
    def __init__(
        ...
        self.digichem_version = digilib.__version__ if digichem_version is None else digichem_version
