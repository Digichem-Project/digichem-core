...
# Digichem imports.
from digilib.file import File_converter
import digilib.file.types as file_types
import digilib.log
from digilib.memory import Memory
from digilib.misc.io import expand_path
...
class Chk_to_fchk(File_converter):
    ...
    def __init__(self, *args, chk_file = None, fchk_file = None, memory = None, formchk_executable = None, **kwargs):
        """
        ...
        formchk_executable = formchk_executable or "formchk"
    ...
    def make_files(self):
        ...
        if formchk_proc.returncode != 0:
            ...
            digilib.log.get_logger().debug(formchk_proc.stdout)
