...
from digilib.config.locations import user_config_location
from digilib.misc.io import atomic_write
from digilib.translate import Cube_grid_points
...
class Digilib_options(Configurable):
    """
...
Possible options are:
 ...
 vesta: A style attempting to mimic that of VESTA.""",
        ...
        batoms = Options(help = "Beautiful Atoms/Blender specific options (only applies if engine == 'batoms'",
            ...
            engine = Option(help = "The blender rendering engine to use", choices = ["cycles", "eevee", "workbench"], default = "cycles")
            # TODO: Colour options.
        ),
