...
from digilib.result.nmr import NMR_shielding, NMR_spin_couplings_list, NMR_list
from digilib.result.alignment.base import Minimal, Alignment
import digilib.log
    ...
    def post_parse(self):
        ...
        try:
            ...
            if self.profile_file and self.profile_file.exists():
                digilib.log.get_logger().warning("Could not parse profile.csv file; profiling data will be unavailable", exc_info=True)
