    ...
    def parse_std2_log(self):
        ...
        with open(self.auxiliary_files['std2_file'], "rt") as std2_file:
            ...
            for line_no, line in enumerate(std2_file):
                if line_no == 0:
                    ...
                    try:
                        ...
                        digilib.log.get_logger().warning("Failed to parse std2 start time", exc_info = True)
            ...
            try:
                ...
                digilib.log.get_logger().warning("Failed to parse std2 end time", exc_info = True)
