...
from digilib.file.prattle import Oprattle_formats, Openprattle_converter
from digilib.test.util import ethane_xyz, benzene_cdx, c6h6_cml, benzene_implicit_cml, benzene_explicit_cml, cyclohexane_implicit_cml, cyclohexane_explicit_cml, acetone_BH3_implicit_cml, acetone_BH3_explicit_cml, benzene_explicit_cdx, benzene_implicit_cdx
