...
class Loader_parent_node(urwid.ParentNode):
    ...
    def __init__(self, loader, *args, **kwargs):
        ...
        :param loader: The Configurable loader we represent, this loader should have children.
        """
        urwid.ParentNode.__init__(self, loader, *args, **kwargs)

    def load_child_keys(self):
        loader = self.get_value()
        return range(len(loader.NEXT))
