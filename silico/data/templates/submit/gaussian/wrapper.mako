...
%if program.calculation.scratch_directory is not None:
## Not setting the scratch dir is a seriously bad idea (because it will default to the cwd (I think)), but is technically allowed.
