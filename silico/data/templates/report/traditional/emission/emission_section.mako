...
<div class="section">
    <h2 class="section__header">${emission.transition_type.capitalize()} ${"{}<sub>{}</sub>".format(emission.multiplicity_symbol, emission.multiplicity_level)} Emission</h2>
...
%>
<div class="section">
    <h2 class="section__header">${emission.transition_type.capitalize()} ${"{}<sub>{}</sub>".format(emission.multiplicity_symbol, emission.multiplicity_level)} Emission Spectrum</h2>
    <div class="section__body">
