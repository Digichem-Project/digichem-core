...
%if vibrations.simulated_IR_graph.relative_path() is not None:
<div class="section">
	...
	<div class="section__body">
		<div class="imageBlock imageBlock--wide">
			...
			<div class="imageBlock__caption">IR spectrum (simulated Gaussian functions with FWHM: ${vibrations.simulated_IR_graph.fwhm} cm<sup>-1</sup>)</div>
		</div>
	</div>
</div>
%endif