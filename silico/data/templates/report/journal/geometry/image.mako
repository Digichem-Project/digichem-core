...
<div class="resultImage resultImage--multi">
    ...
    <div class="resultImage__caption resultImage__caption--multi"><div class="caption">Figure</div> ${report.captions("figure", image_name)}: ${caption}. A: In the X/Y plane, B: In the X/Z plane, C: In the Z/Y plane, D: 45° to the axes.</div>
</div>