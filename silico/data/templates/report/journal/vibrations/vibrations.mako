...
<div class="content">
	...
	Finally there ${inflector.plural("was", len(report.result.vibrations.negative))} <div class="result"><div class="result__value">${text_integer(len(report.result.vibrations.negative))}</div> <div class="result__title">calculated negative frequencies</div></div>.
</div>
