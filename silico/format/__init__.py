...
VERTICAL_EMISSION_CLASS_HANDLE = ["VERT", "VERTICAL", "vertical emission"]
ADIABATIC_EMISSION_CLASS_HANDLE = ["ADIA", "ADIABATIC", "adiabatic emission"]
...
ORBITALS_CLASS_HANDLE = ["ORB", "ALPHA", "MOS", "molecular orbitals", "orbitals"]
