...
Calculation submission is handled by the ``silico submit`` subprogram, which is detailed in this section, and a detailed, step-by-step :ref:`walk-through <tutorial>` is also available for those new to Silico.
